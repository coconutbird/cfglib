...
where
    ...
    P: EdgeProblem<G>,
{
    solve_edge_problem_from_with_config(graph, problem, seeds, EdgeSolveConfig::unbounded())
}
...
where
    ...
    P: TryEdgeProblem<G>,
{
    try_solve_edge_problem_with_config(graph, problem, EdgeSolveConfig::unbounded())
}
...
where
    ...
    P: TryEdgeProblem<G>,
{
    try_solve_edge_problem_from_with_config(graph, problem, seeds, EdgeSolveConfig::unbounded())
}
