...
///
/// [`search`](super::search) answers questions about nodes. This function is
...
/// with (or `None` when the walk ran to completion).
///
/// [`search`](super::search) answers questions about nodes; this answers questions whose
